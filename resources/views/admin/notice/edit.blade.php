                    ...
                    <form action="{{ route('admin.notice.update', $notice->id) }}" method="POST"
                                ...
                                <div class="col-md-9">
                                    <select name="category_id" class="form-control">
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" @if ($category->id == $notice->category_id) selected @endif>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <input type="date" class="form-control" name="date" id="date" value="{{ $notice->date }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="checkbox" name="publish_to_scroll" id="publish_to_scroll"
                                        @if ($notice->publish_to_scroll == 1) checked @endif value="1"> Publish to Scroll
                                </div>
                            </div>
                        </div>
