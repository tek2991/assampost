                    ...
                    <form action="{{ route('admin.office.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control" name="latitude" id="latidute" step=".0000001">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" class="form-control" name="longitude" id="longidute" step=".0000001">
                                </div>
                            </div>
                        </div>
